...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(_owner == msg.sender, "Must be owner of this contract");
        _;
    }
...
contract Pausable is Ownable {
    ...
    function setState(bool state) public onlyOwner {
        require(_paused != state, "Already in requested state");
        _paused = state;
...
contract ERC721 is Pausable, ERC165 {
    ...
    function balanceOf(address owner) public view returns (uint256) {
        ...
        // https://github.com/OpenZeppelin/openzeppelin-contracts/blob/4a9cc8b4918ef3736229a5cc5a310bdc17bf759f/contracts/utils/Counters.sol
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(
            to != tokenOwner,
            "Address cannot be approved. Address is already owner of token."
        );
        require(
    ...
    function _transferFrom(
        ...
        require(
            ...
            "Origin address is not the owner of the token"
        );
        require(to != address(0), "Destination address is invalid");
